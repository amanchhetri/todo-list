  ...
  return (
    <div>
      <div className="g-row">
        ...
        <span className="header__title2">by Kenny</span>
        <div className="g-col">
              ...
              if (completedTasks.find((elem) => elem.id === el.id)) {
                return (
                  <div className="task-item task-item--completed" key={i}>
                    <div className="cell">
                      <button
                        className="btn btn--icon task-item__button task-item__button active"
                        type="button"
                        onClick={() => dispatch(taskCompleted(el))}
                      >
                        <span className="material-icons">done</span>
                      </button>
                    </div>
                    <div className="cell">
                      <div className="task-item__title">{el.data}</div>
                    </div>
                    {/* <h3>{el.data}</h3> */}
                    <div className="cell">
